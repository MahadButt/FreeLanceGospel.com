...
const Forum = (props) => {
    ...
    const handleForumSection = (index) => {
                            ...
                            forumData.topics.map((topic, index) => (
                                <div key={topic.id} className="content-item">
                                  <div 
                                    ...
                                    onClick={ () => handleForumSection(index)}
                                  >
                                  ...
                                  >
                                    <Table responsive borderless>
                                      {/*<thead>
                                        <tr>
                                          <th><div className="forum-section-label">Forum Section</div></th>
                                        </tr>
                                      </thead>*/}
                                      <tbody>
                                        {
                                          topic.sections.map(section => (
                                            <tr key={section.id}>
                                              <td>
                                                <div>
                                                    <NavLink 
                                                        to={`/forum-section/?section_id=${section.id}&topic_id=${topic.id}`} 
