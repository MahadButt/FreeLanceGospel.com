...
const Categories = () => {
    ...
    async function loadCategories() {
        ...
        const { data } = await axios.get(`/admin/get-quiz-categories?limit=${15}&offset=${offset}`,
            {
                headers: {
    ...
    const UpdateCategoryRequest = async () => {
        ...
        try {
            const { data } = await axios.patch(
                `/admin/update-quiz-catetory/${activeCategory?.id}`,
                payload,
                ...
                <Table.Row key={category.id}>
                    ...
                    <Table.Cell width="3">
                        ...
                        <Button
                            ...
                            size="tiny"
                            as={Link}
                            to={`/questions/?edit=true&category_id=${category?.id}`}
                        >
                            Questions
                        </Button>
